...
const AnimatedInternal = React.forwardRef((_a, ref) => {
  var _b = _a, { as, children } = _b, rest = __objRest(_b, ["as", "children"]);
  const Element = as || "div";
  const [shouldRender, setRender] = useState(rest.show);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, shouldRender && /* @__PURE__ */ React.createElement(Element, __spreadProps(__spreadValues({
    ref
  }, cleanedProps), {
...
const AnimatedInternalFactory = (props) => /* @__PURE__ */ React.createElement(AnimatedInternal, __spreadValues({}, props));
const TransientAnimatedInternalFactory = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(AnimatedInternal, __spreadValues({}, cleaned));
};
const Animated = {
...
export { $Animated, Animated as default };
//# sourceMappingURL=react-mount-animation.js.map
